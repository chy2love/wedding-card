...
export function DDayPop() {
  ...
  const diff = Math.ceil(moment.duration(weddingDay.diff(today)).asDays());

  return (
    <div className="absolute w-[353px] h-[49px] bg-[#FF1D89] flex items-center px-5 rounded-[6px] top-[230px] left-[50%] translate-x-[-50%]">
